...
# Source 2 mods
mod_info_metamodsource2=(MOD "metamodsource2" "Metamod: Source 2.X Dev Build" "${metamodsource2url}" "${metamodsource2latestfile}" "0" "LowercaseOff" "${systemdir}" "addons/metamod/metaplugins.ini;" "source2;" "GAMES" "NOTGAMES" "https://www.sourcemm.net" "Plugins Framework - Source 2 update.")
