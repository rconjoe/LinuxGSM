...
# Source2 mods
mod_info_metamodsource2=(MOD "metamodsource2" "Metamod: Source2 (Dev Build)" "${metamodsource2url}" "${metamodsource2download}" "0" "LowercaseOff" "${systemdir}" "addons/metamod/metaplugins.ini;" "source2;" "GAMES" "NOTGAMES" "https://www.sourcemm.net" "Plugins Framework")
